...
@section('content')
    <center>
        <form action="/search/pelatihan" method="GET" class="form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-4" style="margin-bottom: 60px">
            <div class="input-group mr-3 w-50 border rounded" style="border-color: #0A2E54">
                <input class="form-control border-end-0 border rounded" type="search" placeholder="Cari Pelatihan Lainnya" id="example-search-input" name="searchpelat">
    ...
    <div class="mb-4" style="font-family: Comfortaa">
        ...
        <h6 class="text-muted">{{$pelatihan->NAME}} - {{$pelatihan->created_at}} WIB</h6>
    </div>
